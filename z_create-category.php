                ...
                <div class="col-md-12">
                    ...
                    <form action="<?= $base_url ?>/src/controllers/CategoryController.php" method="post" enctype='multipart/form-data'>
                        <div class="mb-3">
                            ...
                            <input type="eng_cat" name="eng_cat" id="eng_cat" class="form-control" value="">

                        </div>

                        <div class="mb-3">
                            <label for="hn_cat" class="form-label">Hindi Name</label>
                            <input type="hn_cat" name="hn_cat" id="hn_cat" class="form-control" value="">
